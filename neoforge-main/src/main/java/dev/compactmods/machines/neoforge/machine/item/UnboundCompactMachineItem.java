...
import dev.compactmods.machines.util.DataComponentHelper;
...
public class UnboundCompactMachineItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flags) {
        ...
        if (sneaking && registries != null) {
            DataComponentHelper.addComponentInfo(stack, Machines.DataComponents.ROOM_TEMPLATE, context, tooltip::add, flags);
        } else {
