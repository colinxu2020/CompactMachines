...
public interface Advancements {
     ...
     */
    ResourceLocation HOW_DID_YOU_GET_HERE = Constants.modRL("how_did_you_get_here");

    /**
     * Root advancement. Required for vanilla's tree design.
     */
    ResourceLocation ROOT = Constants.modRL("root");

    /**
     * Granted when a player first crafts machine items.
     */
    ResourceLocation FOUNDATIONS = Constants.modRL("foundations");

    /**
     * Granted on first pickup of a PSD item.
     */
    ResourceLocation GOT_SHRINKING_DEVICE = Constants.modRL("got_shrinking_device");

    /**
     * Granted if a player tries to enter a machine room they're currently in.
     */
    ResourceLocation RECURSIVE_ROOMS = Constants.modRL("recursion");
    ...
    ResourceLocation CLAIMED_TINY_MACHINE = Constants.modRL("claimed_machine_tiny");
     ...
     */
    @Deprecated(since = "2.0.0", forRemoval = true)
    ResourceLocation CLAIMED_SMALL_MACHINE = Constants.modRL("claimed_machine_small");
     ...
     */
    @Deprecated(since = "2.0.0", forRemoval = true)
    ResourceLocation CLAIMED_NORMAL_MACHINE = Constants.modRL("claimed_machine_normal");
     ...
     */
    @Deprecated(since = "2.0.0", forRemoval = true)
    ResourceLocation CLAIMED_LARGE_MACHINE = Constants.modRL("claimed_machine_large");
     ...
     */
    @Deprecated(since = "2.0.0", forRemoval = true)
    ResourceLocation CLAIMED_GIANT_MACHINE = Constants.modRL("claimed_machine_giant");
     ...
     */
    @Deprecated(since = "2.0.0", forRemoval = true)
    ResourceLocation CLAIMED_MAX_MACHINE = Constants.modRL("claimed_machine_max");
}
