...
public class KeyHelper {
  ...
  public static ResourceKey<Block> blockResKey(String id) {
	 return ResourceKey.create(Registries.BLOCK, Constants.modRL(id));
  }

  @NotNull
  public static TagKey<Item> itemTagKey(String id) {
	 return TagKey.create(Registries.ITEM, Constants.modRL(id));
  }

  public static TagKey<Block> blockTag(String id) {
	 return TagKey.create(Registries.BLOCK, Constants.modRL(id));
  }

  public static ResourceKey<Item> itemResKey(String id) {
	 return ResourceKey.create(Registries.ITEM, Constants.modRL(id));
  }
}
